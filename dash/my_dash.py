...
app.layout = html.Div([
    # html.Img(src='assets\Boya.png', style={
...
def update_graph(selected_file):
    ...
    # 创建交互式图表
    fig = go.Figure(data=go.Scatter(x=voltage, y=current, mode='markers+lines',
                                    text=voltage_current_data[1] + ", " + voltage_current_data[2]))
...
def switch_file(options, current_value):
